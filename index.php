<?php include  $_SERVER['DOCUMENT_ROOT']."/practice/db2.php"; session_start();?>
<!doctype html>
<head>
<meta charset="UTF-8">
<title>게시판</title>
...
<div id="board_area">
  ...
  <h4>자유롭게 글을 쓸 수 있는 게시판입니다.</h4>
      ...
      <tbody>
        <tr>
          ...
          <?php 
            ...
            { ?>
            <a href="/practice/read.php?idx=<?php echo $board["idx"];?>"><?php echo $title;}?><span class="re_ct">[<?php echo $rep_count; ?>]</span></a></td>
            <?php $seq = $board['idx'] ?>

          <td width="120"><?php echo $board['name']?></td>
          <td width="100"><?php echo $board['date']?></td>
          <td width="100"><?php echo $board['hit']; ?></td>
          <?php echo '<td class="like-container"><button type="button" class="btn-like" data-article-id="'.$seq.'">'
            .'<span class="heart-shape">♡</span> <span class="like-count">'.$board['thumbup'].'</span></button></td>' ?>
        </tr>
      </tbody>
      <?php } ?>
    </table>
    ...
    <div id="write_btn">
      <a href="/practice/writer.php"><button>글쓰기</button></a>
    </div>
  </div>
</body>
</html>